  ...
  return (
    <SvgIcon viewBox="0 0 640 480" {...props}>
      <defs>
        ...
        <linearGradient id="h" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse" xlinkHref="#a" />
        <linearGradient id="v" x1="484.8" x2="484.8" y1="311.7" y2="317.6" gradientUnits="userSpaceOnUse" xlinkHref="#b" />
        <linearGradient id="o" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse" xlinkHref="#a" />
        <linearGradient id="p" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse" xlinkHref="#a" />
        <linearGradient id="q" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse" xlinkHref="#a" />
        <linearGradient id="r" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse" xlinkHref="#a" />
        <linearGradient id="u" x1="484.8" x2="484.8" y1="311.7" y2="317.6" gradientUnits="userSpaceOnUse" xlinkHref="#b" />
        <linearGradient id="x" x1="98.9" x2="125" y1="1440.2" y2="1440.2" gradientTransform="scale(4.45715 .22436)" gradientUnits="userSpaceOnUse" xlinkHref="#a" />
        <linearGradient id="j" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse" xlinkHref="#a" />
        <linearGradient id="l" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse" xlinkHref="#a" />
        <linearGradient id="m" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse" xlinkHref="#a" />
        <linearGradient id="i" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse" xlinkHref="#a" />
        <linearGradient id="s" x1="484.8" x2="484.8" y1="311.7" y2="317.6" gradientUnits="userSpaceOnUse" xlinkHref="#b" />
        <linearGradient id="y" x1="47.9" x2="61.7" y1="3054.2" y2="3054.2" gradientTransform="scale(9.12405 .1096)" gradientUnits="userSpaceOnUse" xlinkHref="#a" />
        <clipPath id="ni-c">
      ...
      <g clip-path="url(#ni-c)" transform="matrix(.8 0 0 .8 -80 0)">
        ...
        <g fill="url(#h)">
          ...
          <g id="n" fill="url(#i)">
            ...
            <use width="100%" height="100%" y="-1.1" fill="url(#l)" xlinkHref="#k" />
            <use width="100%" height="100%" y="-2.2" fill="url(#m)" xlinkHref="#k" />
          </g>
          <use width="100%" height="100%" y="-3.3" fill="url(#o)" xlinkHref="#n" />
          <use width="100%" height="100%" y="-6.7" fill="url(#p)" xlinkHref="#n" />
